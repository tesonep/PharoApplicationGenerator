...
EXPORT(void) embeddedImageShowProgress(size_t totalSize, size_t currentSize){
	// We do nothing.
} 

EXPORT(int) embeddedImageIsDirectory(const char* aPath){
...
EXPORT(FileAccessHandler) embeddedFileAccess = {
	...
	embeddedImageShowProgress,
	embeddedImageIsDirectory
};
